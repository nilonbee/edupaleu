...
const StatCard = ({
  ...
  return (
    <div className="md:row-span-1 xl:row-span-2 bg-white col-span-1 shadow-sm border border-gray-200 rounded-lg flex flex-col justify-between">
      {/* HEADER */}
      <div>
      ...
      <div className="flex mb-6 items-center justify-around gap-4 px-5">
        <div className="rounded-full p-5 bg-orange-50 border-orange-200 border">
          {primaryIcon}
        </div>
